                        ...
                        <div className="p-4 text-gray-900">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <div className="space-x-2">
                                    <Link
                                        href={route('students.schedule', student.student_id)}
                                        className="px-3 py-1 text-sm bg-purple-500 text-white rounded hover:bg-purple-700 transition duration-150 ease-in-out"
                                    >
                                        View Schedule
                                    </Link>
                                    <button

...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/students/info/{studentId}', [StudentController::class, 'showStudentInfo'])->name('students.show');
    
    Route::put('/students/info/{studentId}', [StudentController::class, 'update'])->name('students.update');
});
